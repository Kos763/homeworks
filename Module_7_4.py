...
score_1 = 40
score_2 = 42
print('Команда Мастеров кода решила задач: {}'.format(score_1))
...
challenge_result = 'Кто победитель?'
tasks_total = score_1 + score_2
time_avg = 45.2
print(f'Сегодня было решено {tasks_total}, в среднем по {time_avg} секунд на задачу!')
